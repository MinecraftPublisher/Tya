  ...
  if (msg.channel.type === "dm") {
    ...
    if (fs.existsSync("activates/" + msg.channel.id)) {
      ...
      //Doing keepup
        ...
        msg.channel.send(
          "Due to the hosting restrictions of Tya,\nTya would turn off once in a while.\nYou can support it by clicking on this link and waking up tya.\nhttps://tya-discord-bot.glitch.me"
        );
      }
      //Pingggggggggg
      ...
      //Deactivation
        ...
        if (msg.member.hasPermission("ADMINISTRATOR")) {
          fs.unlink("activates/" + msg.channel.id, function(err) {
            msg.reply(
              "I WILL LEAVE!!!\nBut good ghost 👻  is watching you forever!ever!ever!ever!"
            );
          });
          msg.guild.leave();
        } else {
      ...
      //DA REAL CODE
        ...
        if (fs.existsSync("teachers/" + msg.author)) {
          ...
          if (clean(msg.content.toLowerCase(), msg) == "nothing") {
            ...
            fs.readFile("teachers/" + msg.author, "utf8", function(err, data) {
              fs.writeFile(
                "learns/" + data,
